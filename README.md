...
| 1185 | [Day of the Week](https://leetcode.com/problems/day-of-the-week/) | 🟢 Easy | Math / Zeller's Congruence | [C++](./solution/Solution_1185.cpp) | O(1) | O(1) | |
...
| 2600 | [K Items With the Maximum Sum](https://leetcode.com/problems/k-items-with-the-maximum-sum/) | 🟢 Easy | Math / Greedy | [C++](./solution/Solution_2600.cpp) | O(1) | O(1) ||
...
| 1513 | [Number of Substrings With Only 1s](https://leetcode.com/problems/number-of-substrings-with-only-1s/) | 🟡 Medium | Math / String / Dynamic Programming | [C++](./solution/Solution_1513.cpp) | O(N) | O(1) | |
...
| 0168 | [Excel Sheet Column Title](https://leetcode.com/problems/excel-sheet-column-title/) | 🟢 Easy | Math / Base Conversion | [C++](./solution/Solution_0168.cpp) | O(log26 N) | O(1) |  |
| 0171 | [Excel Sheet Column Number](https://leetcode.com/problems/excel-sheet-column-number/) | 🟢 Easy | Math / Base Conversion | [C++](./solution/Solution_0171.cpp) | O(N) | O(1) | |
| 0405 | [Convert a Number to Hexadecimal](https://leetcode.com/problems/convert-a-number-to-hexadecimal/) | 🟢 Easy | Math / Bit Manipulation | [C++](./solution/Solution_0405.cpp) | O(1) | O(1) | |
...
| 1404 | [Number of Steps to Reduce a Number in Binary Representation to One](https://leetcode.com/problems/number-of-steps-to-reduce-a-number-in-binary-representation-to-one/) | 🟡 Medium | Bit Manipulation / String Simulation | [C++](./solution/Solution_1404.cpp) | O(N) | O(1) | |
...
| 2160 | [Minimum Sum of Four Digit Number After Splitting Digits](https://leetcode.com/problems/minimum-sum-of-four-digit-number-after-splitting-digits/) | 🟢 Easy | Math / Greedy / Sorting | [C++](./solution/Solution_2160.cpp) | O(1) | O(1) ||
...
| 3079 | [Find the Sum of Encrypted Integers](https://leetcode.com/problems/find-the-sum-of-encrypted-integers/) | 🟢 Easy | Simulation / Math | [C++](./solution/Solution_3079.cpp) | O(N * D) | O(1) | |
...
## <a name="Bit-bitmask-subset-enumeration"></a>📊 Bit Manipulation - Bitmask Subset Enumeration (位元運算 - 遮罩子集合列舉)
| # | 題目 | 難度 | 標籤 | 程式碼 | 時間 | 空間 | 詳解 |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **0078** | [Subsets](https://leetcode.com/problems/subsets/) | 🟡 Medium | Bit Manipulation / Bitmask / Backtracking | [C++](./solution/Solution_0078_1.cpp) | O(2ᴺ*N) | O(2^N * N) |  |
| **0090** | [Subsets II](https://leetcode.com/problems/subsets-ii/) | 🟡 Medium | Bit Manipulation / Sorting / Hash Set (Duplicate De-duplication) | [C++](./solution/Solution_90.cpp) | O(2ᴺ*N log(2ᴺ))* | O(2ᴺ*N) |  |
...
| 2278 | [Percentage of Letter in String](https://leetcode.com/problems/percentage-of-letter-in-string/) | 🟢 Easy | String / Counting | [C++](./solution/Solution_2278.cpp) | O(N) | O(1) | |
| 2399 | [Check Distances Between Same Letters](https://leetcode.com/problems/check-distances-between-same-letters/) | 🟢 Easy | Hash Table / String / Array | [C++](./solution/Solution_2399.cpp) | O(N) | O(1) ||
...
| 3477 | [Fruits Into Baskets II](https://leetcode.com/problems/fruits-into-baskets-ii/) | 🟢 Easy | Simulation / Brute Force | [C++](./solution/Solution_3477.cpp) | O(N^2) | O(1) | [Note](#3477-fruits-into-baskets-ii) |
...
| 1437 | [Check If All 1's Are at Least Length K Places Away](https://leetcode.com/problems/check-if-to-all-1s-are-at-least-length-k-places-away/) | 🟢 Easy | Array / Simulation | [C++](./solution/Solution_1437.cpp) | O(N) | O(1) |  |
| 1464 | [Maximum Product of Two Elements in an Array](https://leetcode.com/problems/maximum-product-of-two-elements-in-an-array/) | 🟢 Easy | Array / Simulation / Greedy | [C++](./solution/Solution_1464.cpp) | O(N) | O(1) | |
...
| 1614 | [Maximum Nesting Depth of the Parentheses](https://leetcode.com/problems/maximum-nesting-depth-of-the-parentheses/) | 🟢 Easy | String / Stack / Simulation | [C++](./solution/Solution_1614.cpp) | O(N) | O(1) | |
...
| 2319 | [Check if Matrix Is X-Matrix](https://leetcode.com/problems/check-if-matrix-is-x-matrix/) | 🟢 Easy | Array / Matrix | [C++](./solution/Solution_2319.cpp) | O(n²) | O(1) ||
| 2482 | [Difference Between Ones and Zeros in Row and Column](https://leetcode.com/problems/difference-between-ones-and-zeros-in-row-and-column/) | 🟡 Medium | Matrix / Prefix Sum / Precomputation | [C++](./solution/Solution_2482.cpp) | O(M * N) | O(M + N) | [Note](#2482-difference-between-ones-and-zeros-in-row-and-column) |
...
| 3637 | [Trionic Array I](https://leetcode.com/problems/trionic-array-i/) | 🟢 Easy | Two Pointers / State Transition | [C++](./solution/Solution_3637.cpp) | O(N) | O(1) | |
...
| 1497 | [Check If Array Pairs Are Divisible by k](https://leetcode.com/problems/check-if-array-pairs-are-divisible-by-k/) | 🟡 Medium | Hash Table / Remainder Counting | [C++](./solution/Solution_1497.cpp) | O(N + k) | O(k) | |
...
| 2068 | [Check Whether Two Strings are Almost Equivalent](https://leetcode.com/problems/check-whether-two-strings-are-almost-equivalent/) | 🟢 Easy | Hash Table / String / Counting | [C++](./solution/Solution_2068.cpp) | O(N) | O(1) |  |
...
| 1309 | [Decrypt String from Alphabet to Integer Mapping](https://leetcode.com/problems/decrypt-string-from-alphabet-to-integer-mapping/) | 🟢 Easy | Hash Table / String Parsing | [C++](./solution/Solution_1309.cpp)  | O(N) | O(1) | |
...
| 2357 | [Make Array Zero by Subtracting Equal Amounts](https://leetcode.com/problems/make-array-zero-by-subtracting-equal-amounts/) | 🟢 Easy | Hash Set / Math | [C++](./solution/Solution_2357.cpp) | O(N) | O(N) |  |
...
| **1081** | [Smallest Subsequence of Distinct Characters](https://leetcode.com/problems/smallest-subsequence-of-distinct-characters/) | 🟡 Medium | Monotonic Stack / Greedy | [C++](./solution/Solution_1081.cpp) | O(N) | O(1) | |
...
| 0563 | [Binary Tree Tilt](https://leetcode.com/problems/binary-tree-tilt/) | 🟢 Easy | DFS / Post-order |  [C++](./solution/Solution_0563.cpp) | O(N) | O(H) | |
...
| **0897** | [Increasing Order Search Tree](https://leetcode.com/problems/increasing-order-search-tree/) | 🟢 Easy | DFS / In-order | [C++](./solution/Solution_0897.cpp | O(N) | O(H) |  |
...
| # | 題目 | 難度 | 標籤 | 程式碼 | 時間 | 空間 | 詳解 |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 0648 | [Replace Words](https://leetcode.com/problems/replace-words/) | 🟡 Medium | Trie | [C++](./solution/Solution_0648_1.cpp) | O(N * L) | O(M * L) |  |
...
| 2182 | [Construct String With Repeat Limit](https://leetcode.com/problems/construct-string-with-repeat-limit/) | 🟡 Medium | Greedy / String / Two Pointers / Counting | [C++](./solution/Solution_2182.cpp) | O(N) | O(1) | |
...
| 2554 | [Maximum Number of Integers to Choose From a Range I](https://leetcode.com/problems/maximum-number-of-integers-to-choose-from-a-range-i/) | 🟡 Medium | Array / Hash Table / Greedy / Sorting | [C++](./solution/Solution_2554.cpp) | O(N + M) | O(M) | |
| **2571** | [Minimum Operations to Reduce an Integer to 0](https://leetcode.com/problems/minimum-operations-to-reduce-an-integer-to-0/) | 🟡 Medium | Greedy / Bit Manipulation / Dynamic Programming | [C++](./solution/Solution_2571.cpp) | O(log N) | O(1) | |
...
| 2645 | [Minimum Additions to Make Valid String](https://leetcode.com/problems/minimum-additions-to-make-valid-string/) | 🟡 Medium | Greedy / Simulation | [C++](./solution/Solution_2645.cpp) | O(N) | O(1) |  |
| 2745 | [Construct the Longest New String](https://leetcode.com/problems/construct-the-longest-new-string/) | 🟡 Medium | Greedy / Math / Brainteaser | [C++](./solution/Solution_2745.cpp) | O(1) | O(1) |  |
...
| 3114 | [Latest Time You Can Obtain After Replacing Characters](https://leetcode.com/problems/latest-time-you-can-obtain-after-replacing-characters/) | 🟢 Easy | Greedy / String |  [C++](./solution/Solution_3114.cpp) | O(1) | O(1) |  |
...
| 1493 | [Longest Subarray of 1's After Deleting One Element](https://leetcode.com/problems/longest-subarray-of-1s-after-deleting-one-element/) | 🟡 Medium | Sliding Window / Two Pointers | [C++](./solution/Solution_1493.cpp) | O(N) | O(1) | |
...
| 1248 | [Count Number of Nice Subarrays](https://leetcode.com/problems/count-number-of-nice-subarrays/) | 🟡 Medium | Array / Two Pointers / Sliding Window | [C++](./solution/Solution_1248.cpp) | O(N) | O(1) | 
...
| 3325 | [Count Substrings With K-Frequency Characters I](https://leetcode.com/problems/count-substrings-with-k-frequency-characters-i/) | 🟡 Medium | Sliding Window / Two Pointers | [C++](./solution/Solution_3325.cpp) | O(N) | O(1) | |
