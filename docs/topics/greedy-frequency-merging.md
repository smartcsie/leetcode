...
| 1167 | [Minimum Cost to Connect Sticks](https://leetcode.com/problems/minimum-cost-to-connect-sticks/) | 🟡 Medium | Greedy Frequency Merging | [C++](../problems/1167.md) | O(N log N) | O(N) |
