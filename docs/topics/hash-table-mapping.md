...
| # | 題目 | 難度 | 標籤 | 時間 | 空間 |
| --- | --- | --- | --- | --- | --- |
| 1 | [Two Sum](../problems/0001.md) | 🟢 Easy | Hash Table | O(N) | O(N) |
| 12 | [Integer to Roman](../problems/0012.md) | 🟡 Medium | Math, Hash Table, String | O(1) | O(1) |
...
| 1640 | [Check Array Formation Through Concatenation](../problems/1640.md) | 🟢 Easy | Hash Map | O(N) | O(N) |
| 2133 | [Check if Every Row and Column Contains All Numbers](../problems/2133.md) | 🟢 Easy | Array, Hash Table, Bitset | O(N²) | O(N) |
| 2154 | [Keep Multiplying Found Values by Two](../problems/2154.md) | 🟢 Easy | Array, Hash Table, Simulation | O(N) | O(N) |
| 2342 | [Max Sum of a Pair With Equal Sum of Digits](../problems/2342.md) | 🟡 Medium | Hash Table, Math | O(N*logM) | O(N) |
