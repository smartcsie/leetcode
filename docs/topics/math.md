...
| # | 題目 | 難度 | 標籤 | 時間 | 空間 |
| --- | --- | --- | --- | --- | --- |
| 50 | [Pow(x, n)](../problems/0050.md) | 🟡 Medium | Math, Binary Exponentiation | O(logN) | O(1) |
| 60 | [Permutation Sequence](../problems/0060.md) | 🟡 Medium | Math, Factorial | O(N²) | O(N) |
| 66 | [Plus One](../problems/0066.md) | 🟢 Easy | Math | O(N) | O(1) |
| 137 | [Single Number II](../problems/0137.md) | 🟡 Medium | Math, Hash Set | O(N) | O(N) |
| 172 | [Factorial Trailing Zeroes](../problems/0172.md) | 🟡 Medium | Math | O(log₅N) | O(1) |
| 231 | [Power of Two](../problems/0231.md) | 🟢 Easy | Math | O(1) | O(1) |
...
| 2119 | [A Number After a Double Reversal](../problems/2119.md) | 🟢 Easy | Math | O(1) | O(1) |
| 2177 | [Find Three Consecutive Integers That Sum to a Given Number](../problems/2177.md) | 🟡 Medium | Math | O(1) | O(1) |
| 2310 | [Sum of Numbers With Units Digit K](../problems/2310.md) | 🟡 Medium | Math, Enumeration | O(10) | O(1) |
| 2413 | [Smallest Even Multiple](../problems/2413.md) | 🟢 Easy | Math | O(1) | O(1) |
| 2455 | [Average Value of Even Numbers That Are Divisible by Three](../problems/2455.md) | 🟢 Easy | Math, Array | O(N) | O(1) |
