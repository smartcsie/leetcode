...
| # | 題目 | 難度 | 標籤 | 時間 | 空間 |
| --- | --- | --- | --- | --- | --- |
| 191 | [Number of 1 Bits](../problems/0191.md) | 🟢 Easy | Bit-Manipulation | O(1) | O(1) |
| 201 | [Bitwise AND of Numbers Range](../problems/0201.md) | 🟡 Medium | Bit Manipulation | O(logN) | O(1) |
| 338 | [Counting Bits](../problems/0338.md) | 🟢 Easy | DP, Bit Manipulation | O(N) | O(N) |
| 693 | [Binary Number with Alternating Bits](../problems/0693.md) | 🟢 Easy | Bit Manipulation | O(1) | O(1) |
