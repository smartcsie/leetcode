...
📌 **快速跳轉：** [🔴 生疏清單（351）](#review-shengshu)　[🟣 易忘清單（61）](#review-yiwang)

## 📊 總覽

- **LeetCode 網站 AC 總數：** 976 / 4033 題（最後更新：2026-08-23 21:21）
- **目前收錄總題目數：** 980 題　🔴 生疏：345 題　🟠 再練習：172 題　🟡 練習過：125 題　🟣 易忘：55 題　🟢 熟練：283 題　⚪ 未標記：0 題
...
📌 **快速跳轉：** [🎨 Design（1）](#yiwang-design)　[🔢 Math（23）](#yiwang-math)　[📊 Bit Manipulation（10）](#yiwang-bit-manipulation)　[🔗 String（2）](#yiwang-string)　[🍱 Array（2）](#yiwang-array)　[🌳 Tree（5）](#yiwang-tree)　[🔍 Binary Search（4）](#yiwang-binary-search)　[👥 Pointers（6）](#yiwang-pointers)　[📊 Sorting（2）](#yiwang-sorting)　[🧩 Greedy（6）](#yiwang-greedy)
...
| [array](topics/array.md) | 3 | 9 | 1 | 0 | 15 | 0 | 28 |
...
| [array-prefix-sum](topics/array-prefix-sum.md) | 10 | 1 | 5 | 1 | 2 | 0 | 19 |
...
| [binary-search-build-in](topics/binary-search-build-in.md) | 4 | 0 | 3 | 0 | 1 | 0 | 8 |
...
| [bit-manipulation](topics/bit-manipulation.md) | 2 | 8 | 7 | 4 | 15 | 0 | 36 |
...
| [bit-manipulation-xor](topics/bit-manipulation-xor.md) | 3 | 6 | 5 | 2 | 2 | 0 | 18 |
...
| [linked-list](topics/linked-list.md) | 9 | 4 | 0 | 0 | 2 | 0 | 15 |
...
| [two-pointers-same](topics/two-pointers-same.md) | 15 | 3 | 0 | 0 | 3 | 0 | 21 |
