...
📌 **快速跳轉：** [🟡 練習過清單（194）](#review-lianxiguo)　[🟠 再練習清單（202）](#review-zailianxi)　[🔴 生疏清單（223）](#review-shengshu)

## 📊 總覽

- **LeetCode 網站 AC 總數：** 980 / 4046 題（最後更新：2026-09-08 17:55）
- **目前收錄總題目數：** 980 題　🔴 生疏：221 題　🟠 再練習：194 題　🟡 練習過：174 題　🟣 易忘：110 題　🟢 熟練：281 題　⚪ 未標記：0 題
...
目前共有 194 個解法標記為練習過，持續複習鞏固。

📌 **快速跳轉：** [🔢 Math（12）](#lianxiguo-math)　[📊 Bit Manipulation（10）](#lianxiguo-bit-manipulation)　[🔗 String（12）](#lianxiguo-string)　[🍱 Array（21）](#lianxiguo-array)　[🌳 Tree（15）](#lianxiguo-tree)　[🔍 Binary Search（11）](#lianxiguo-binary-search)　[⛓️ Linked List（5）](#lianxiguo-linked-list)　[👥 Pointers（17）](#lianxiguo-pointers)　[🔑 Hash Table（19）](#lianxiguo-hash-table)　[📚 Stack（3）](#lianxiguo-stack)　[📚 Priority Queue（1）](#lianxiguo-priority-queue)　[📚 Quick Select（1）](#lianxiguo-quick-select)　[📊 Sorting（21）](#lianxiguo-sorting)　[🧩 Dynamic Programming（32）](#lianxiguo-dynamic-programming)　[🧩 Greedy（13）](#lianxiguo-greedy)　[🔢 Backtracking（1）](#lianxiguo-backtracking)
...
| [stack](topics/stack.md) | 3 | 5 | 3 | 0 | 3 | 0 | 14 |
