...
📌 **快速跳轉：** [🔴 生疏清單（278）](#review-shengshu)　[🟣 易忘清單（74）](#review-yiwang)

## 📊 總覽

- **LeetCode 網站 AC 總數：** 980 / 4046 題（最後更新：2026-09-08 17:55）
- **目前收錄總題目數：** 980 題　🔴 生疏：273 題　🟠 再練習：166 題　🟡 練習過：192 題　🟣 易忘：64 題　🟢 熟練：285 題　⚪ 未標記：0 題
...
📌 **快速跳轉：** [🎨 Design（1）](#yiwang-design)　[🔢 Math（21）](#yiwang-math)　[📊 Bit Manipulation（10）](#yiwang-bit-manipulation)　[🔗 String（4）](#yiwang-string)　[🍱 Array（3）](#yiwang-array)　[🌳 Tree（6）](#yiwang-tree)　[🔍 Binary Search（5）](#yiwang-binary-search)　[⛓️ Linked List（1）](#yiwang-linked-list)　[👥 Pointers（9）](#yiwang-pointers)　[🔑 Hash Table（1）](#yiwang-hash-table)　[📊 Sorting（2）](#yiwang-sorting)　[🧩 Dynamic Programming（3）](#yiwang-dynamic-programming)　[🧩 Greedy（8）](#yiwang-greedy)
...
| [array-linear-scan](topics/array-linear-scan.md) | 1 | 5 | 3 | 0 | 15 | 0 | 24 |
...
| [dp-lcs](topics/dp-lcs.md) | 7 | 0 | 5 | 0 | 0 | 0 | 12 |
...
| [dynamic-programming](topics/dynamic-programming.md) | 6 | 0 | 0 | 0 | 0 | 0 | 6 |
...
| [string](topics/string.md) | 5 | 5 | 8 | 1 | 22 | 0 | 41 |
...
| [tree-dfs-global](topics/tree-dfs-global.md) | 4 | 0 | 2 | 1 | 0 | 0 | 7 |
| [tree-dfs-path](topics/tree-dfs-path.md) | 4 | 2 | 19 | 2 | 5 | 0 | 32 |
