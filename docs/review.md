...
📌 **快速跳轉：** [🔴 生疏清單（312）](#review-shengshu)　[🟣 易忘清單（67）](#review-yiwang)

## 📊 總覽

- **LeetCode 網站 AC 總數：** 976 / 4033 題（最後更新：2026-08-23 21:21）
- **目前收錄總題目數：** 980 題　🔴 生疏：306 題　🟠 再練習：167 題　🟡 練習過：163 題　🟣 易忘：60 題　🟢 熟練：284 題　⚪ 未標記：0 題
...
目前共有 67 個解法標記為易忘，建議面試前重點複習。

📌 **快速跳轉：** [🎨 Design（1）](#yiwang-design)　[🔢 Math（23）](#yiwang-math)　[📊 Bit Manipulation（10）](#yiwang-bit-manipulation)　[🔗 String（4）](#yiwang-string)　[🍱 Array（3）](#yiwang-array)　[🌳 Tree（6）](#yiwang-tree)　[🔍 Binary Search（4）](#yiwang-binary-search)　[⛓️ Linked List（1）](#yiwang-linked-list)　[👥 Pointers（7）](#yiwang-pointers)　[📊 Sorting（2）](#yiwang-sorting)　[🧩 Greedy（6）](#yiwang-greedy)
...
| [binary-search-tree](topics/binary-search-tree.md) | 2 | 5 | 7 | 0 | 1 | 0 | 15 |
| [bit-bitmask-subset-enumeration](topics/bit-bitmask-subset-enumeration.md) | 3 | 0 | 1 | 1 | 0 | 0 | 5 |
| [bit-manipulation](topics/bit-manipulation.md) | 1 | 8 | 8 | 4 | 15 | 0 | 36 |
...
| [stack](topics/stack.md) | 3 | 2 | 1 | 0 | 8 | 0 | 14 |
| [string](topics/string.md) | 7 | 5 | 6 | 1 | 22 | 0 | 41 |
...
| [tree](topics/tree.md) | 0 | 0 | 3 | 1 | 3 | 0 | 7 |
...
| [tree-dfs-path](topics/tree-dfs-path.md) | 5 | 2 | 19 | 2 | 6 | 0 | 34 |
