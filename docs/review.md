...
| 57 | [Insert Interval](https://leetcode.com/problems/insert-interval) | 🟡 Medium | Array, Interval | [C++](problems/0057.md) | O(N) | O(N) |
...
| 33 | [Search in Rotated Sorted Array](https://leetcode.com/problems/search-in-rotated-sorted-array) | 🟡 Medium | Array, Binary Search | [C++](problems/0033.md) | O(logN) | O(1) |
...
| 206 | [Reverse Linked List](https://leetcode.com/problems/reverse-linked-list) | 🟢 Easy | Linked List | [C++](problems/0206.md) | O(N) | O(1) |
| 237 | [Delete Node in a Linked List](https://leetcode.com/problems/delete-node-in-a-linked-list) | 🟢 Easy | Linked List | [C++](problems/0237.md) | O(1) | O(1) |
...
| 85 | [Maximal Rectangle](https://leetcode.com/problems/maximal-rectangle/) | 🔴 Hard | Dp Grid Path | [C++](problems/0085.md) | O(M | O(N) |
...
| 121 | [Best Time to Buy and Sell Stock](https://leetcode.com/problems/best-time-to-buy-and-sell-stock/) | 🟢 Easy | Dynamic Programming State Machine | [C++](problems/0121.md) | O(N) | O(1) |
...
| 1986 | [Minimum Number of Work Sessions to Finish the Tasks](https://leetcode.com/problems/minimum-number-of-work-sessions-to-finish-the-tasks/) | 🟡 Medium | Dp Bitmask | [C++](problems/1986.md) | O(3^N)（枚舉所有 mask 的所有子集合） | O(2^N) |
...
| 2376 | [Count Special Integers](https://leetcode.com/problems/count-special-integers/) | 🔴 Hard | Dp Digit | [C++](problems/2376.md) | O(D²)，D 是 n 的位數 | O(1) |
...
| 1405 | [Longest Happy String](https://leetcode.com/problems/longest-happy-string/) | 🟡 Medium | Greedy Exchange Argument | [C++](problems/1405.md) | O((a+b+c) log 3) | O(1) |
...
| 2208 | [Minimum Operations to Halve Array Sum](https://leetcode.com/problems/minimum-operations-to-halve-array-sum/) | 🟡 Medium | Greedy Parity Contribution | [C++](problems/2208.md) | O(N + K log N) | O(N) |
...
| 2279 | [Maximum Bags With Full Capacity of Rocks](https://leetcode.com/problems/maximum-bags-with-full-capacity-of-rocks/) | 🟡 Medium | Greedy Selection Constraints | [C++](problems/2279.md) | O(N log N) | O(N) |
...
| 37 | [Sudoku Solver](https://leetcode.com/problems/sudoku-solver/) | 🔴 Hard | Backtracking Constraint | [C++](problems/0037.md) | O(9^M)，M 是空格數量（最壞情況，實務上剪枝後遠比這快） | O(1)（原地修改，遞迴深度最多 81） |
...
| 51 | [N-Queens](https://leetcode.com/problems/n-queens/) | 🔴 Hard | Backtracking Constraint | [C++](problems/0051.md) | O(N!)（最壞情況） | O(N)（遞迴深度 + 記錄每列皇后位置） |
...
| 526 | [Beautiful Arrangement](https://leetcode.com/problems/beautiful-arrangement/) | 🟡 Medium | Backtracking Permutation | [C++](problems/0526.md) | O(K)，K 是合法排列的總數（實務上遠小於 N!，因為整除 | O(N)（used 陣列 + 遞迴深度） |
...
| 980 | [Unique Paths III](https://leetcode.com/problems/unique-paths-iii/) | 🔴 Hard | Backtracking Grid | [C++](problems/0980.md) | O(4^(可走格數)) | O(M × N)（遞迴深度） |
| 1219 | [Path with Maximum Gold](https://leetcode.com/problems/path-with-maximum-gold/) | 🟡 Medium | Backtracking Grid | [C++](problems/1219.md) | O(4^(有金子的格數))（最壞情況，實務上受限於「不能走 | O(M × N)（遞迴深度最多等於格子數） |
...
| 1947 | [Maximum Compatibility Score Sum](https://leetcode.com/problems/maximum-compatibility-score-sum/) | 🟡 Medium | Backtracking Permutation | [C++](problems/1947.md) | O(M! | O(M)（used 陣列 + 遞迴深度） |
...
| 2305 | [Fair Distribution of Cookies](https://leetcode.com/problems/fair-distribution-of-cookies/) | 🟡 Medium | Backtracking Constraint | [C++](problems/2305.md) | O(K^N)（最壞情況，靠剪枝大幅縮減） | O(N)（遞迴深度） |
...
| 1461 | [Check If a String Contains All Binary Codes of Size K](https://leetcode.com/problems/check-if-a-string-contains-all-binary-codes-of-size-k/) | 🟡 Medium | Sliding Window, Hash Set, Bit Manipulation | [C++](problems/1461.md) | O(N\*K) |  |
