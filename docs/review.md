...
📌 **快速跳轉：** [🔴 生疏清單（395）](#review-shengshu)　[🟣 易忘清單（33）](#review-yiwang)

## 📊 總覽

- **LeetCode 網站 AC 總數：** 863 / 4019 題（最後更新：2026-08-15 20:50）
- **目前收錄總題目數：** 865 題　🔴 生疏：390 題　🟠 再練習：163 題　🟡 練習過：13 題　🟣 易忘：32 題　🟢 熟練：267 題　⚪ 未標記：0 題
...
| [design](topics/design.md) | 1 | 1 | 0 | 4 | 1 | 0 | 7 |
...
目前共有 33 個解法標記為易忘，建議面試前重點複習。

📌 **快速跳轉：** [🎨 Design（4）](#yiwang-design)　[🔢 Math（15）](#yiwang-math)　[📊 Bit Manipulation（2）](#yiwang-bit-manipulation)　[🔗 String（1）](#yiwang-string)　[🍱 Array（1）](#yiwang-array)　[👥 Pointers（4）](#yiwang-pointers)　[🧩 Greedy（6）](#yiwang-greedy)
