...
📌 **快速跳轉：** [🔴 生疏清單（223）](#review-shengshu)　[🟣 易忘清單（113）](#review-yiwang)

## 📊 總覽

- **LeetCode 網站 AC 總數：** 980 / 4046 題（最後更新：2026-09-08 17:55）
- **目前收錄總題目數：** 980 題　🔴 生疏：221 題　🟠 再練習：169 題　🟡 練習過：462 題　🟣 易忘：95 題　🟢 熟練：33 題　⚪ 未標記：0 題
...
目前共有 113 個解法標記為易忘，建議面試前重點複習。

📌 **快速跳轉：** [🎨 Design（3）](#yiwang-design)　[🔢 Math（23）](#yiwang-math)　[📊 Bit Manipulation（17）](#yiwang-bit-manipulation)　[🔗 String（7）](#yiwang-string)　[🍱 Array（9）](#yiwang-array)　[🌳 Tree（20）](#yiwang-tree)　[🔍 Binary Search（5）](#yiwang-binary-search)　[⛓️ Linked List（4）](#yiwang-linked-list)　[👥 Pointers（9）](#yiwang-pointers)　[🔑 Hash Table（1）](#yiwang-hash-table)　[📊 Sorting（2）](#yiwang-sorting)　[🧩 Dynamic Programming（4）](#yiwang-dynamic-programming)　[🧩 Greedy（8）](#yiwang-greedy)　[🔢 Sliding Window（1）](#yiwang-sliding-window)
...
| 43 | [Multiply Strings](https://leetcode.com/problems/multiply-strings/) | 🟡 Medium | String, String | [C++](problems/0043.md) | O(M\*N) | O(M+N) |
...
| 557 | [Reverse Words in a String III](https://leetcode.com/problems/reverse-words-in-a-string-iii) | 🟢 Easy | String | [C++](problems/0557.md) | O(N) | O(1) |
...
| # | 題目 | 難度 | 標籤 | 解法檔案 | 時間 | 空間 |
| --- | --- | --- | --- | --- | --- | --- |
| 94 | [Binary Tree Inorder Traversal](https://leetcode.com/problems/binary-tree-inorder-traversal) | 🟢 Easy | Tree Traversal, Tree, DFS | [C++](problems/0094.md) | O(N) | O(H) |
| 94 | [Binary Tree Inorder Traversal](https://leetcode.com/problems/binary-tree-inorder-traversal) | 🟢 Easy | Tree Traversal | [C++](problems/0094.md) | O(N) | O(H) |
...
| 144 | [Binary Tree Preorder Traversal](https://leetcode.com/problems/binary-tree-preorder-traversal) | 🟢 Easy | Tree Traversal, DFS | [C++](problems/0144.md) | O(N) | O(H) |
| 144 | [Binary Tree Preorder Traversal](https://leetcode.com/problems/binary-tree-preorder-traversal) | 🟢 Easy | Tree Traversal | [C++](problems/0144.md) | O(N) | O(H) |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| [2d-array](topics/2d-array.md) | 0 | 8 | 9 | 0 | 0 | 0 | 17 |
| [array](topics/array.md) | 1 | 10 | 16 | 2 | 0 | 0 | 29 |
| [array-boyer-moore](topics/array-boyer-moore.md) | 1 | 1 | 0 | 0 | 0 | 0 | 2 |
| [array-continuous-counting](topics/array-continuous-counting.md) | 0 | 5 | 5 | 1 | 0 | 0 | 11 |
...
| [array-linear-scan](topics/array-linear-scan.md) | 1 | 5 | 17 | 0 | 2 | 0 | 25 |
| [array-min-max](topics/array-min-max.md) | 0 | 1 | 3 | 0 | 0 | 0 | 4 |
...
| [binary-search-tree](topics/binary-search-tree.md) | 0 | 2 | 14 | 0 | 0 | 0 | 16 |
| [bit-bitmask-subset-enumeration](topics/bit-bitmask-subset-enumeration.md) | 2 | 0 | 1 | 2 | 0 | 0 | 5 |
| [bit-manipulation](topics/bit-manipulation.md) | 0 | 8 | 24 | 5 | 0 | 0 | 37 |
...
| [bit-manipulation-or](topics/bit-manipulation-or.md) | 0 | 0 | 4 | 1 | 1 | 0 | 6 |
| [bit-manipulation-xor](topics/bit-manipulation-xor.md) | 0 | 5 | 8 | 3 | 1 | 0 | 17 |
...
| [fast-slow-pointers](topics/fast-slow-pointers.md) | 2 | 0 | 10 | 1 | 0 | 0 | 13 |
...
| [greedy-string-construction](topics/greedy-string-construction.md) | 4 | 2 | 2 | 0 | 0 | 0 | 8 |
| [greedy-validity-repair](topics/greedy-validity-repair.md) | 2 | 0 | 1 | 1 | 0 | 0 | 4 |
| [hamming-distance](topics/hamming-distance.md) | 0 | 2 | 2 | 0 | 0 | 0 | 4 |
| [hash-table-counting](topics/hash-table-counting.md) | 3 | 7 | 14 | 0 | 0 | 0 | 24 |
| [hash-table-existence](topics/hash-table-existence.md) | 2 | 6 | 10 | 1 | 0 | 0 | 19 |
...
| [hash-table-uniqueness](topics/hash-table-uniqueness.md) | 2 | 6 | 12 | 0 | 0 | 0 | 20 |
...
| [tree](topics/tree.md) | 0 | 0 | 3 | 1 | 1 | 0 | 5 |
...
| [tree-traversal](topics/tree-traversal.md) | 0 | 0 | 5 | 2 | 0 | 0 | 7 |
...
| [two-pointers-swap](topics/two-pointers-swap.md) | 0 | 4 | 10 | 0 | 0 | 0 | 14 |
