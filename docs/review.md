...
📌 **快速跳轉：** [🔴 生疏清單（340）](#review-shengshu)　[🟣 易忘清單（64）](#review-yiwang)

## 📊 總覽

- **LeetCode 網站 AC 總數：** 976 / 4033 題（最後更新：2026-08-23 21:21）
- **目前收錄總題目數：** 980 題　🔴 生疏：334 題　🟠 再練習：169 題　🟡 練習過：135 題　🟣 易忘：58 題　🟢 熟練：284 題　⚪ 未標記：0 題
...
目前共有 340 個解法標記為生疏，建議找時間重新練習。

📌 **快速跳轉：** [🎨 Design（1）](#shengshu-design)　[🔢 Math（2）](#shengshu-math)　[📊 Bit Manipulation（10）](#shengshu-bit-manipulation)　[🔗 String（10）](#shengshu-string)　[🍱 Array（14）](#shengshu-array)　[🌳 Tree（21）](#shengshu-tree)　[🔍 Binary Search（10）](#shengshu-binary-search)　[⛓️ Linked List（3）](#shengshu-linked-list)　[👥 Pointers（24）](#shengshu-pointers)　[🔑 Hash Table（9）](#shengshu-hash-table)　[📚 Stack（11）](#shengshu-stack)　[📚 Priority Queue（6）](#shengshu-priority-queue)　[📚 Queue（1）](#shengshu-queue)　[📚 Quick Select（1）](#shengshu-quick-select)　[🕸️ Graph（5）](#shengshu-graph)　[📊 Sorting（16）](#shengshu-sorting)　[🧩 Dynamic Programming（89）](#shengshu-dynamic-programming)　[🧩 Greedy（59）](#shengshu-greedy)　[🔢 Backtracking（25）](#shengshu-backtracking)　[🔢 Sliding Window（23）](#shengshu-sliding-window)
...
| [fast-slow-pointers](topics/fast-slow-pointers.md) | 5 | 0 | 3 | 1 | 5 | 0 | 14 |
