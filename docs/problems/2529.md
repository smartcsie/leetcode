...
[在 LeetCode 上查看](https://leetcode.com/problems/maximum-count-of-positive-integer-and-negative-integer)

**難度:** 🟢 Easy　**標籤:** Binary Search Find Left Bound　**時間:** O(logN)　**空間:** O(1)　**熟悉度:** 🟡 練習過
