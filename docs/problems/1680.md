...
[在 LeetCode 上查看](https://leetcode.com/problems/concatenation-of-consecutive-binary-numbers/)

**難度:** 🟡 Medium　**標籤:** Bit Manipulation, Bit Manipulation　**時間:** O(N)　**空間:** O(1)　**熟悉度:** 🟡 練習過
