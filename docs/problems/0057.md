...
**難度:** 🟡 Medium　**標籤:** Array Difference Array, Interval　**時間:** O(N)　**空間:** O(N)　**熟悉度:** 🟡 練習過
...
> **第一個while，把interval尾巴小於新interval頭都加入ans<br>**
> **第二個while，把可以合併到新interval的都合併，把新interval加入ans<br>**
> **新interval的尾巴大於等於interval的頭<br>**
> **第三個while，把後面的interval加入ans<br>**
