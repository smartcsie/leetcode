...
[在 LeetCode 上查看](https://leetcode.com/problems/sum-of-all-subset-xor-totals/)

**難度:** 🟢 Easy　**標籤:** Bit Manipulation Xor, Math, Combinatorics　**時間:** O(N)　**空間:** O(1)　**熟悉度:** 🟣 易忘
...
> **所有子集XOR總和的總和，等於「全體元素的 Bitwise OR 」乘以 2^(N-1)。**<br>
