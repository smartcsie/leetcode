...
[在 LeetCode 上查看](https://leetcode.com/problems/convert-sorted-list-to-binary-search-tree/)

**難度:** 🟡 Medium　**標籤:** Binary Search Tree, Tree　**時間:** O(NlogN)　**空間:** O(logN)　**熟悉度:** 🟡 練習過
...
> **prev->next = nullptr 切斷後：**<br>
> **head → 左半段的頭 → 遞迴建左子樹**<br>
> **slow → 當前 root**<br>
> **slow->next → 右半段的頭 → 遞迴建右子樹**<br>
