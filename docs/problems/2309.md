...
[在 LeetCode 上查看](https://leetcode.com/problems/greatest-english-letter-in-upper-and-lower-case/)

**難度:** 🟢 Easy　**標籤:** Bit Manipulation And, Hash Table, Bit Manipulation　**時間:** O(N)　**空間:** O(1)　**熟悉度:** 🟢 熟練
