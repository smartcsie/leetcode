...
[在 LeetCode 上查看](https://leetcode.com/problems/uncrossed-lines/)

**難度:** 🟡 Medium　**標籤:** Dynamic Programming Lcs, DP, LCS　**時間:** O(N*M)　**空間:** O(M)　**熟悉度:** 🟡 練習過
...
> 同1143[Longest Common Subsequence](https://leetcode.com/problems/longest-common-subsequence/)

**相關題目:** [583](../problems/0583.md), [1143](../problems/1143.md)
