...
[在 LeetCode 上查看](https://leetcode.com/problems/subarray-sum-equals-k)

**難度:** 🟡 Medium　**標籤:** Array, Hash Table, Prefix Sum　**時間:** O(N)　**空間:** O(N)　**熟悉度:** 🟣 易忘
