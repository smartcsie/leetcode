...
[在 LeetCode 上查看](https://leetcode.com/problems/probability-of-a-two-boxes-having-the-same-number-of-distinct-balls/)

**難度:** 🔴 Hard　**標籤:** Dp Probability　**時間:** O(∏(balls[i]+1))（枚舉每種顏色的分配方式）　**空間:** O(K)（遞迴深度）　**熟悉度:** 🔴 生疏
