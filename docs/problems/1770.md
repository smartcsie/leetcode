...
[在 LeetCode 上查看](https://leetcode.com/problems/maximum-score-from-performing-multiplication-operations/)

**難度:** 🔴 Hard　**標籤:** Greedy Selection Constraints　**時間:** O(M²)　**空間:** O(M²)　**熟悉度:** 🔴 生疏
