...
[在 LeetCode 上查看](https://leetcode.com/problems/x-of-a-kind-in-a-deck-of-cards/)

**難度:** 🟢 Easy　**標籤:** Math Gcd, GCD, Hash Table　**時間:** O(N)　**空間:** O(N)　**熟悉度:** 🟡 練習過
