...
[在 LeetCode 上查看](https://leetcode.com/problems/find-common-elements-between-two-arrays/)

**難度:** 🟢 Easy　**標籤:** Bit Manipulation, Hash Table, Bitset　**時間:** O(N+M)　**空間:** O(1)　**熟悉度:** 🟢 熟練
