...
[在 LeetCode 上查看](https://leetcode.com/problems/check-if-n-and-its-double-exist)

**難度:** 🟢 Easy　**標籤:** Hash Table Existence, Hash Table　**時間:** O(N)　**空間:** O(N)　**熟悉度:** 🟢 熟練　🏆 **最佳解**　👑 **代表題（Unordered Set）**
...
> 找 num/2 是否在hash set中 <br>
> 用(seen.count(num / 2) && (num & 1) == 0)  <br>
