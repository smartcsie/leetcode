...
[在 LeetCode 上查看](https://leetcode.com/problems/how-many-numbers-are-smaller-than-the-current-number/)

**難度:** 🟢 Easy　**標籤:** Array Prefix Sum, Counting Sort, Prefix Sum　**時間:** O(N+K)　**空間:** O(K)　**熟悉度:** 🟡 練習過
