...
**難度:** 🟡 Medium　**標籤:** Backtracking Combination, Backtracking, Recursion　**時間:** O(N*2ᴺ)　**空間:** O(N)　**熟悉度:** 🔴 生疏　👑 **代表題（Bitmask Subset Enumeration）**
...
**難度:** 🟡 Medium　**標籤:** Bit Bitmask Subset Enumeration, Bitmask, Backtracking　**時間:** O(2ᴺ*N)　**空間:** O(2^N*N)　**熟悉度:** 🟡 練習過
