...
[在 LeetCode 上查看](https://leetcode.com/problems/find-a-corresponding-node-of-a-binary-tree-in-a-clone-of-that-tree/)

**難度:** 🟢 Easy　**標籤:** Tree Dfs Path, DFS, Tree Traversal　**時間:** O(N)　**空間:** O(H)　**熟悉度:** 🟠 再練習
