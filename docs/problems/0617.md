...
[在 LeetCode 上查看](https://leetcode.com/problems/merge-two-binary-trees)

**難度:** 🟢 Easy　**標籤:** Tree Dfs Path, DFS, Recursion　**時間:** O(min(N,M))　**空間:** O(min(N,M))　**熟悉度:** 🟠 再練習　👑 **代表題（Tree merge）**
