...
[在 LeetCode 上查看](https://leetcode.com/problems/check-if-all-characters-have-equal-number-of-occurrences)

**難度:** 🟢 Easy　**標籤:** Hash Table Uniqueness, Hash Table, Counting　**時間:** O(N)　**空間:** O(1)　**熟悉度:** 🟡 練習過
