...
[在 LeetCode 上查看](https://leetcode.com/problems/boats-to-save-people/)

**難度:** 🟡 Medium　**標籤:** Greedy Sorting Decision　**時間:** O(N log N)　**空間:** O(1)　**熟悉度:** 🟡 練習過
...
> **排序後，挑選最重(right)和最輕(left)的一起上船，低於limit，就一起上船，left++，right--**<br>
> **如果最重(right)和最輕(left)的大於limit，只能重的(right)一條船，right--**<br>
