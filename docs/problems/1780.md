...
[在 LeetCode 上查看](https://leetcode.com/problems/check-if-number-is-a-sum-of-powers-of-three/)

**難度:** 🟡 Medium　**標籤:** Math, Base-3　**時間:** O(log₃N)　**空間:** O(1)　**熟悉度:** 🟠 再練習
...
> 題目如果改成Powers of N，if(n % 3 >= 2) return false;<br>
