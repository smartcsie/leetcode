...
[在 LeetCode 上查看](https://leetcode.com/problems/convert-binary-number-in-a-linked-list-to-integer/)

**難度:** 🟢 Easy　**標籤:** Linked List, Bit Manipulation　**時間:** O(N)　**空間:** O(1)　**熟悉度:** 🔴 生疏
