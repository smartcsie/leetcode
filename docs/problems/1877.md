...
[在 LeetCode 上查看](https://leetcode.com/problems/minimize-maximum-pair-sum-in-array/)

**難度:** 🟡 Medium　**標籤:** Two Pointers Opposite, Two Pointers, Greedy, Sorting　**時間:** O(NlogN)　**空間:** O(1)*　**熟悉度:** 🟢 熟練
