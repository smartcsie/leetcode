...
**難度:** 🟡 Medium　**標籤:** Dp Lcs, Dynamic Programming Lcs　**時間:** O(M*N)　**空間:** O(M*N)　**熟悉度:** 🟡 練習過　👑 **代表題（LCS）**
...
> **同1035[Uncrossed Lines](https://leetcode.com/problems/uncrossed-lines/description/)**<br>

**相關題目:** [583](../problems/0583.md), [1035](../problems/1035.md)
