...
[在 LeetCode 上查看](https://leetcode.com/problems/longest-word-in-dictionary-through-deleting/)

**難度:** 🟡 Medium　**標籤:** String, Two Pointers　**時間:** O(DlogD+D*M)　**空間:** O(1)　**熟悉度:** 🟠 再練習
