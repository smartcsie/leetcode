# 1170. Compare Strings by Frequency

[在 LeetCode 上查看](https://leetcode.com/problems/compare-strings-by-frequency-of-the-smallest-character/)

**難度:** 🟡 Medium　**標籤:** Sorting, Binary Search　**時間:** O(NlogN+MlogN)　**空間:** O(N)　**熟悉度:** 🔴 生疏
