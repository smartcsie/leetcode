...
[在 LeetCode 上查看](https://leetcode.com/problems/smallest-absent-positive-greater-than-average/)

**難度:** 🟢 Easy　**標籤:** Hash Table Existence, Hash Set　**時間:** O(N)　**空間:** O(N)　**熟悉度:** 🟠 再練習
