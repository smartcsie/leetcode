...
[在 LeetCode 上查看](https://leetcode.com/problems/neighboring-bitwise-xor/)

**難度:** 🟡 Medium　**標籤:** Bit Manipulation, Math　**時間:** O(N)　**空間:** O(1)　**熟悉度:** 🟠 再練習
...
> **!accumulate(derived.begin(), derived.end(), 0, bit_xor<int>());**
