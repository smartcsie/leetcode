...
[在 LeetCode 上查看](https://leetcode.com/problems/keep-multiplying-found-values-by-two)

**難度:** 🟢 Easy　**標籤:** Hash Table Mapping, Hash Table, Simulation　**時間:** O(N)　**空間:** O(N)　**熟悉度:** 🟢 熟練
