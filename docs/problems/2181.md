...
[在 LeetCode 上查看](https://leetcode.com/problems/merge-nodes-in-between-zeros/)

**難度:** 🟡 Medium　**標籤:** Linked List, In-place Modification　**時間:** O(N)　**空間:** O(1)　**熟悉度:** 🟡 練習過
...
>**如果下一個node存在，而且下一個node值不為0，把值加到cur，cur->next = cur->next->next**<br>
>**尾巴0處理，如果下一個node存在，而且為0，且下一個節點是尾巴節點，cur->next=nullptr**<br>
