...
[在 LeetCode 上查看](https://leetcode.com/problems/rearrange-characters-to-make-target-string/)

**難度:** 🟢 Easy　**標籤:** Hash Table Intersection, Hash Table, Counting　**時間:** O(N+M)　**空間:** O(1)　**熟悉度:** 🟢 熟練
...
**相關題目:** [1160](../problems/1160.md), [1189](../problems/1189.md)
