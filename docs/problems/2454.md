# 2454. 2425. Bitwise XOR of All Pairings

[在 LeetCode 上查看](https://leetcode.com/problems/2425-bitwise-xor-of-all-pairings/)

**難度:** 中等 (Medium)　**標籤:** 　**時間:** O(N + M)，遍歷兩個陣列各一次。　**空間:** O(1)。
