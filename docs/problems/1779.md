...
[在 LeetCode 上查看](https://leetcode.com/problems/find-nearest-point-that-has-the-same-x-or-y-coordinate/)

**難度:** 🟢 Easy　**標籤:** Array, Simulation, Manhattan Distance　**時間:** O(N)　**空間:** O(1)　**熟悉度:** 🟠 再練習
