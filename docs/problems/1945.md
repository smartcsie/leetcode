...
[在 LeetCode 上查看](https://leetcode.com/problems/sum-of-digits-of-string-after-convert/)

**難度:** 🟢 Easy　**標籤:** String, Simulation　**時間:** O(N+K*log(SUM))　**空間:** O(1)　**熟悉度:** 🟠 再練習
