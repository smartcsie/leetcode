...
**難度:** 🟡 Medium　**標籤:** Greedy Priority Queue　**時間:** O(N + K log N)　**空間:** O(N)　**熟悉度:** 🟡 練習過
...
> **[Greedy策略]挑選每次數字裡面最大的減半，保證operations最小**<br>
> **先把所有元素放入priority queue**<br>
> **計算target為所有元素和的一半**<br>
> **迴圈條件reduced小於target**<br>
> **每次pop元素出來，減半，加到reduced，並放回 heap**<br>
