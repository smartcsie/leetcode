...
[在 LeetCode 上查看](https://leetcode.com/problems/string-without-aaa-or-bbb/)

**難度:** 🟡 Medium　**標籤:** Greedy String Construction, Recursion, String Construction　**時間:** O(A + B)　**空間:** O(A + B)　**熟悉度:** 🟢 熟練　🏆 **最佳解**
