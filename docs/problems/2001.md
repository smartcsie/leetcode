...
[在 LeetCode 上查看](https://leetcode.com/problems/number-of-pairs-of-interchangeable-rectangles)

**難度:** 🟡 Medium　**標籤:** Hash Table Counting, Hash Table　**時間:** O(N)　**空間:** O(N)　**熟悉度:** 🟠 再練習
