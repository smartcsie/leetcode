...
[在 LeetCode 上查看](https://leetcode.com/problems/divide-array-into-arrays-with-max-difference/)

**難度:** 🟡 Medium　**標籤:** Array, Greedy, Sorting　**時間:** O(NlogN)　**空間:** O(1)或O(N)*　**熟悉度:** 🔴 生疏
