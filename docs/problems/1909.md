...
[在 LeetCode 上查看](https://leetcode.com/problems/remove-one-element-to-make-the-array-strictly-increasing/)

**難度:** 🟢 Easy　**標籤:** Greedy, Two Candidates　**時間:** O(N)　**空間:** O(1)　**熟悉度:** 🟣 易忘
...
> **遇到違規 nums[i-1] >= nums[i]**<br>
> **先假設刪 nums[i-1]**<br>
> **檢查 nums[i-2] 和 nums[i] 是否合法**<br>
> **不合法：改刪 nums[i]，用 nums[i] = nums[i-1] 模擬**<br>
