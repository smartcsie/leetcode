...
[在 LeetCode 上查看](https://leetcode.com/problems/ugly-number-iii/)

**難度:** 🟡 Medium　**標籤:** Binary Search, Math　**時間:** O(log(2E9))　**空間:** O(1)　**熟悉度:** 🔴 生疏　👑 **代表題**

**技巧:** overflow handle、gcd、lcm
...
> **[overflow handle]LCM 計算用 long long**<br>
