...
[在 LeetCode 上查看](https://leetcode.com/problems/check-if-word-occurs-as-a-prefix-of-any-word-in-a-sentence/)

**難度:** 🟢 Easy　**標籤:** String Character Classification　**時間:** O(N)　**空間:** O(W)　**熟悉度:** 🟢 熟練
...
**技巧:** istringstream、string prefix
...
**相關題目:** [2185](../problems/2185.md), [2255](../problems/2255.md)
