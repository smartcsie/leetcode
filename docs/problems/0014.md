...
**難度:** 🟢 Easy　**標籤:** String　**時間:** O(S)　**空間:** O(1)　**熟悉度:** 🟠 再練習　🏆 **最佳解**　👑 **代表題（Longest Common Prefix）**
...
> **外迴圈為char index cIdx從0到strs[0].size()-1**<br>
> **內層迴圈為string index sIdx從 1 ~ strs.size()**<br>
> **這一題用Trie解，complexity並不會比較好**<br>
