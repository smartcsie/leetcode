# 2705. 2707. Extra Characters in a String

[在 LeetCode 上查看](https://leetcode.com/problems/2707-extra-characters-in-a-string/)

**難度:** 待補充　**標籤:** 　**時間:** O(N) - 單次遍歷，統計字母出現頻率。　**空間:** O(1) - 固定大小計數陣列。
