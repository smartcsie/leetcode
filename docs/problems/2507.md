...
[在 LeetCode 上查看](https://leetcode.com/problems/smallest-value-after-replacing-with-sum-of-prime-factors/)

**難度:** 🟡 Medium　**標籤:** Math, Prime Factorization　**時間:** O(logN*sqrt(N))　**空間:** O(1)　**熟悉度:** 🔴 生疏
