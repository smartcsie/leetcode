...
**難度:** 🟢 Easy　**標籤:** String　**時間:** O(min(L1,L2,L3))　**空間:** O(1)　**熟悉度:** 🟢 熟練
...
> **跟0014.[Longest Common Prefix](https://leetcode.com/problems/longest-common-prefix)很像，**<br>
> **此題三字串，0014多字串，int minLen = min({n1, n2, n3});<br>
