...
[在 LeetCode 上查看](https://leetcode.com/problems/bitwise-xor-of-all-pairings/)

**難度:** 🟡 Medium　**標籤:** Bit Manipulation, Math　**時間:** O(N+M)　**空間:** O(1)　**熟悉度:** 🟡 練習過
...
> 如果nums1 size是奇數，把所有nums2的element xor到 ans<br>
> 如果nums2 size是奇數，把所有nums1的element xor到 ans<br>
> 回傳 ans<br>
