...
[在 LeetCode 上查看](https://leetcode.com/problems/maximum-rows-covered-by-columns/)

**難度:** 🟡 Medium　**標籤:** Bit Bitmask Subset Enumeration, Bitmask, Combinatorics　**時間:** O(2ᴺ*M+M*N)　**空間:** O(M)　**熟悉度:** 🟡 練習過
