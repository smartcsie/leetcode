...
[在 LeetCode 上查看](https://leetcode.com/problems/determine-color-of-a-chessboard-square/)

**難度:** 🟢 Easy　**標籤:** Bit Manipulation, Math, String　**時間:** O(1)　**空間:** O(1)　**熟悉度:** 🟢 熟練
