...
[在 LeetCode 上查看](https://leetcode.com/problems/count-operations-to-obtain-zero/)

**難度:** 🟢 Easy　**標籤:** Math Factor Enumeration, Euclidean Algorithm, Simulation　**時間:** O(log(min(NUM1,NUM2)))　**空間:** O(1)　**熟悉度:** 🟠 再練習
