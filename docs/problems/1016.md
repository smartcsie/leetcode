...
[在 LeetCode 上查看](https://leetcode.com/problems/binary-string-with-substrings-representing-1-to-n/)

**難度:** 🟡 Medium　**標籤:** Bit Manipulation, Bit Manipulation, Sliding Window　**時間:** O(N*LEN)　**空間:** O(1)　**熟悉度:** 🟡 練習過
...
> **轉二進制，string binary = bitset<32>(i).to_string();**
