...
[在 LeetCode 上查看](https://leetcode.com/problems/divide-players-into-teams-of-equal-skill/)

**難度:** 🟡 Medium　**標籤:** Array, Two Pointers, Sorting　**時間:** O(NlogN)　**空間:** O(1)或O(N)*　**熟悉度:** 🔴 生疏
