...
[在 LeetCode 上查看](https://leetcode.com/problems/check-whether-two-strings-are-almost-equivalent/)

**難度:** 🟢 Easy　**標籤:** Hash Table Intersection, Hash Table, Counting　**時間:** O(N)　**空間:** O(1)　**熟悉度:** 🟢 熟練
