...
[在 LeetCode 上查看](https://leetcode.com/problems/minimum-sum-of-four-digit-number-after-splitting-digits/)

**難度:** 🟢 Easy　**標籤:** Math Digit Decomposition, Greedy, Sorting　**時間:** O(1)　**空間:** O(1)　**熟悉度:** 🟢 熟練
