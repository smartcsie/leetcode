...
[在 LeetCode 上查看](https://leetcode.com/problems/count-subarrays-of-length-three-with-a-condition/)

**難度:** 🟢 Easy　**標籤:** Array, Sliding Window, Simulation　**時間:** O(N)　**空間:** O(1)　**熟悉度:** 🔴 生疏
