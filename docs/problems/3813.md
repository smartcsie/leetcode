...
[在 LeetCode 上查看](https://leetcode.com/problems/vowel-consonant-score/)

**難度:** 🟢 Easy　**標籤:** String Character Classification　**時間:** O(N)　**空間:** O(1)　**熟悉度:** 🟡 練習過
...
> **注意最後除0**，return consonant == 0 ? 0 : vowels / consonant;**<br>
