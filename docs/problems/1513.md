...
[在 LeetCode 上查看](https://leetcode.com/problems/number-of-substrings-with-only-1s/)

**難度:** 🟡 Medium　**標籤:** Math Combination, String, Dynamic Programming　**時間:** O(N)　**空間:** O(1)　**熟悉度:** 🟠 再練習
