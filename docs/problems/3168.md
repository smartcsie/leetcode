# 3168. Minimum Number of Chairs

[在 LeetCode 上查看](https://leetcode.com/problems/minimum-number-of-chairs-in-a-waiting-room/)

**難度:** 🟢 Easy　**標籤:** Array Linear Scan, Simulation　**時間:** O(N)　**空間:** O(1)　**熟悉度:** 🟢 熟練
