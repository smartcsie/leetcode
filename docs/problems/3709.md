# 3709. 3079. Find the Sum of Encrypted Integers

[在 LeetCode 上查看](https://leetcode.com/problems/3079-find-the-sum-of-encrypted-integers/)

**難度:** 待補充　**標籤:** 　**時間:** O(N) - 單次遍歷，計算相鄰元素差的絕對值總和。　**空間:** O(1) - 僅使用常數空間。
