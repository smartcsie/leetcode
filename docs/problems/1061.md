...
[在 LeetCode 上查看](https://leetcode.com/problems/lexicographically-smallest-equivalent-string/)

**難度:** 🟡 Medium　**標籤:** Greedy String Construction　**時間:** O(N + M * α(26))　**空間:** O(26)　**熟悉度:** 🔴 生疏
