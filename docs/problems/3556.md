...
[在 LeetCode 上查看](https://leetcode.com/problems/sum-of-largest-prime-substrings/)

**難度:** 🟡 Medium　**標籤:** Math Prime, Brute Force　**時間:** O(N²*sqrt(M))　**空間:** O(1)　**熟悉度:** 🟡 練習過
...
> **if (val == m1 || val == m2 || val == m3) return;**<br>
