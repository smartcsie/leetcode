...
[在 LeetCode 上查看](https://leetcode.com/problems/make-array-zero-by-subtracting-equal-amounts/)

**難度:** 🟢 Easy　**標籤:** Hash Table Uniqueness, Hash Set　**時間:** O(N)　**空間:** O(N)　**熟悉度:** 🟣 易忘
