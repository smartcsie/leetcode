...
[在 LeetCode 上查看](https://leetcode.com/problems/balance-a-binary-search-tree/)

**難度:** 🟡 Medium　**標籤:** Binary Search Tree, BST　**時間:** O(N)　**空間:** O(N)　**熟悉度:** 🟡 練習過
...
> **同108[Convert Sorted Array to Binary Search Tree](https://leetcode.com/problems/convert-sorted-array-to-binary-search-tree/)**<br>
> **只是前面多一個步驟inorder蒐集nums**<br>

**相關題目:** [108](../problems/0108.md)
