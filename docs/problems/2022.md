...
[在 LeetCode 上查看](https://leetcode.com/problems/convert-1d-array-into-2d-array)

**難度:** 🟢 Easy　**標籤:** 2d Array　**時間:** O(M*N)　**空間:** O(1)　**熟悉度:** 🟢 熟練　🏆 **最佳解**　👑 **代表題（1D 2D transform）**
...
>  **[注意]邊界條件 if(m * n != original.size()) return {};** <br>
