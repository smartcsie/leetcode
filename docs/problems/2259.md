...
[在 LeetCode 上查看](https://leetcode.com/problems/remove-digit-from-number-to-maximize-result/)

**難度:** 🟢 Easy　**標籤:** Greedy Digit Construction, String　**時間:** O(N)　**空間:** O(N)　**熟悉度:** 🟡 練習過
...
> **先由左往右掃描，找到第一個目標digit位置，且小於右邊字元找到則回傳**<br>
> **上面方法沒找到，由右邊往左找rfind，找到第一個目標digit位置回傳**<br>
