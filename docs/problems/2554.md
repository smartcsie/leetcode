...
[在 LeetCode 上查看](https://leetcode.com/problems/maximum-number-of-integers-to-choose-from-a-range-i/)

**難度:** 🟡 Medium　**標籤:** Greedy Selection Constraints, Hash Table, Greedy, Sorting　**時間:** O(N+M)　**空間:** O(M)　**熟悉度:** 🟡 練習過
...
> **貪婪法法則，挑最小且不再banned的數，所以for loop 由小到大**<br>
