...
[在 LeetCode 上查看](https://leetcode.com/problems/remove-k-digits/)

**難度:** 🟡 Medium　**標籤:** Greedy Digit Construction　**時間:** O(N)　**空間:** O(N)　**熟悉度:** 🟡 練習過
...
> **由左往右，把char推入string stack**<br>
> **推入前，如果stack裡面比char大，一直pop**<br>
