...
[在 LeetCode 上查看](https://leetcode.com/problems/construct-binary-tree-from-preorder-and-postorder-traversal/)

**難度:** 🟡 Medium　**標籤:** Tree Construction, Recursion　**時間:** O(N)　**空間:** O(N)　**熟悉度:** 🔴 生疏
