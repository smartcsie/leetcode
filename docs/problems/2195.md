...
[在 LeetCode 上查看](https://leetcode.com/problems/append-k-integers-with-minimal-sum/)

**難度:** 🟡 Medium　**標籤:** Binary Search On Answer, Binary Search　**時間:** O(NlogN)　**空間:** O(1)　**熟悉度:** 🔴 生疏
