...
[在 LeetCode 上查看](https://leetcode.com/problems/number-of-ways-to-wear-different-hats-to-each-other/)

**難度:** 🔴 Hard　**標籤:** Dp Digit　**時間:** O(40 * 2^N * 平均每頂帽子對應的人數)　**空間:** O(40 * 2^N)　**熟悉度:** 🔴 生疏
