...
[在 LeetCode 上查看](https://leetcode.com/problems/subsets-ii/)

## 解法：backtracking-combination

**難度:** 🟡 Medium　**標籤:** Backtracking, Sorting　**時間:** O(N*2ᴺ)　**空間:** O(N)　**熟悉度:** 🔴 生疏
...
**難度:** 🟡 Medium　**標籤:** Bit Manipulation, Sorting, Hash Set (Duplicate De-duplication)　**時間:** O(2ᴺ*Nlog(2ᴺ))*　**空間:** O(2ᴺ*N)　**熟悉度:** 🔴 生疏
