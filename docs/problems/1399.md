...
[在 LeetCode 上查看](https://leetcode.com/problems/count-largest-group/)

**難度:** 🟢 Easy　**標籤:** Math Digit Decomposition, Digit Manipulation, Counting　**時間:** O(N * D)　**空間:** O(1)　**熟悉度:** 🟢 熟練　🏆 **最佳解**

**📅 練習歷程:**

- ✅ **2026-09-23** 對

**技巧:** running maximum with reset、digit sum
