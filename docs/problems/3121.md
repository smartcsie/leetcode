...
[在 LeetCode 上查看](https://leetcode.com/problems/count-the-number-of-special-characters-ii/)

**難度:** 🟡 Medium　**標籤:** String Character Classification, String Processing　**時間:** O(N)　**空間:** O(1)　**熟悉度:** 🟢 熟練
...
> **大寫紀錄最左邊，小寫紀錄最右邊**<br>
> **最後count計算所有char，小寫index在大寫前面(小於)**<br>
