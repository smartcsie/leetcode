...
[在 LeetCode 上查看](https://leetcode.com/problems/construct-the-minimum-bitwise-array-i/)

**難度:** 🟢 Easy　**標籤:** Bit Manipulation, Math　**時間:** O(N)　**空間:** O(N)　**熟悉度:** 🟣 易忘
...
>**lowestZeroBit是右邊屬過來第幾位是0，例如5(101)是2，例如23(10111)是4**<br>
>**另外有一個很難記的技巧，~nums[i] & -~nums[i]**<br>
