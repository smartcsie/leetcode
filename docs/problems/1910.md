...
[在 LeetCode 上查看](https://leetcode.com/problems/remove-all-occurrences-of-a-substring/)

**難度:** 🟡 Medium　**標籤:** String, String　**時間:** O(N*M)　**空間:** O(N)　**熟悉度:** 🟠 再練習　👑 **代表題（String Erase）**
