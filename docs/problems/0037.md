...
[在 LeetCode 上查看](https://leetcode.com/problems/sudoku-solver/)

**難度:** 🔴 Hard　**標籤:** Backtracking Constraint　**時間:** O(9^M)，M 是空格數量（最壞情況，實務上剪枝後遠比這快）　**空間:** O(1)（原地修改，遞迴深度最多 81）　**熟悉度:** 🔴 生疏
