...
[在 LeetCode 上查看](https://leetcode.com/problems/minimum-operations-to-make-the-array-k-increasing/)

**難度:** 🔴 Hard　**標籤:** Greedy Optimal Partitioning　**時間:** O(N log N)　**空間:** O(N)　**熟悉度:** 🔴 生疏
