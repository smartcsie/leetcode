...
[在 LeetCode 上查看](https://leetcode.com/problems/minimum-ascii-delete-sum-for-two-strings/)

**難度:** 🟡 Medium　**標籤:** Dynamic Programming Lcs, String　**時間:** O(M×N)　**空間:** O(M×N)　**熟悉度:** 🔴 生疏
