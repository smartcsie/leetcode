...
[在 LeetCode 上查看](https://leetcode.com/problems/equal-row-and-column-pairs/)

**難度:** 🟡 Medium　**標籤:** Hash Table Intersection, Hash Map, Matrix Simulation　**時間:** O(N³logN) 或 O(N²logN)*　**空間:** O(N²)　**熟悉度:** 🟡 練習過
